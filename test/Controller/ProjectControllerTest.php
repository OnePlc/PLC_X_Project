<?php
/**
 * ProjectControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Project Module
 *
 * @category Test
 * @package Project
...
namespace OnePlaceTest\Project\Controller;

use OnePlace\Project\Controller\ProjectController;
...
class ProjectControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/project/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('project');
        $this->assertControllerName(ProjectController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ProjectController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/project/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('project');
        $this->assertControllerName(ProjectController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ProjectController');
