...
use OnePlace\Project\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/project/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('project-api');
    }
}
